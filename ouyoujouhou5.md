...
例えば、1ロット100個単位で抜き取り検査をして不良品の個数が1個以下で、100LOT分確認して  
その確率が80%とすると、それを合格率として、製品の抜き出し検査の基準と決める。

その合格率を検査基準に採用する際に問題となるのが、本当は合格なのに不合格となってしまうことと、  
本当は不合格なのに合格となってしまうLOTが発生してしまうこと。

前者だと、本当は合格なのに不合格でそのLOTが廃棄となってしまうなど、生産側が余計なロスを多く出してしまう。  
後者だと、本当は不合格な品質のLOTを出荷してしまう。

不良品率は、実際に試行しなくても1LOTの個数と不良品の個数だけ分かれば下記のように定まる。

100個中不良品が1個である場合、不良品率は1 / 100 * 100 = 1%  
100個中不良品が2個である場合、不良品率は2 / 100 * 100 = 2%  
100個中不良品が3個である場合、不良品率は3 / 100 * 100 = 3%  
...
...
実際は、1lotが10000個に対し不良品1個で不良品率0.01%が80%の確率で出現し、これを合格基準値に  
するような製品の精度だと想像する。
