...
故障、災害の発生やお店への来客などの事象のモデル化にポアソン過程が対応する。
...
以上から、ポアソン分布は単位時間内に事象が起こる確率のこと。

1時間という単位時間あたりに平均100人来客が来る場合、その事象の発生間隔がｔ単位時間である確率密度Ｐ(ｒ)は指数分布に従う。  
...
確率変数は6個あるので、どれか一つの目が出る確率は1/6 * 6 = 1
