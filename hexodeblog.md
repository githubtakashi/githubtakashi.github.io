...
Hexoがブログのおおもと、インフラで、そこにいろいろHexoの機能を拡張できるプラグインのようなものがいっぱいある。  
なので、Hexoの使い方、基礎を覚えつつ、機能の拡張、カスタマイズをプラスで覚える。  

Hexoでのブログの作り方など、読んでいても頭が整理できずごちゃごちゃになっていたのは、  
Hexoの使い方とカスタムテーマなど機能拡張の方法・使い方(コマンドもあり)などについてきちんと分けて考えていなかったからだと思う。  
なので、まずはHexoについての使い方をきちんと整理しておく。

使うos：　　
MacOS(導入手順についての記事を見るとどれもMacOSの環境での手順だったため)->2022夏時点ですでにmacosのパソコンは売ってしまい  
存在しないので、Windowsをメインとしてこの記事の加筆をしている。
