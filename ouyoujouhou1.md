...
Aの部分に入る記号として、9種類ほど定義されている。  
応用情報の勉強ではM/M/1モデルしか出題されないぽいので、下記の"M"という記号と意味だけ覚えておく。

M: マルコフ過程という性質を持ち、キューへの到着がランダムに発生し、ポアソン分布となる。  
...
ポアソン過程とは、イベント間の平均時間が分かっているけど、間隔について、いつ起こるかがランダムなイベントをモデル化した概念。

イベント間の平均時間はわかっているけど、イベントが短期間に連続して起こるか、何年も空けて起こるかがランダムなこと。  
