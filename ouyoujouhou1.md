...
-5を表現したいので、反対の数字である5を利用し、5+(-5)=0という式を作る。絶対値が同じ負の数と正の数を足すと0になることを利用している。  
これをそのまま2進数に当てはめる。

求めたい2進数の-5をxとすると、  
0000101-x=0000000

ここで、0000101をビット反転したものを求めると、1111010となり、0000101に1111010を加えると、0000101+1111010=1111111となる。  
