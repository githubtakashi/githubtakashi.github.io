...
日常のtodoやメモを書いています。  
todo管理にgithub pagesを使っているので、どのPCでも、どんな場所でも編集・内容の確認ができます。  
github pagesはマークダウンで編集できるので、メモとしても見やすく、マークダウンの書式に沿って書くことで  
情報を整理しやすいです。  
ページのリリース時にマークダウンからhtmlに変換されます。
